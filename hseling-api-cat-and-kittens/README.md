...
## Development environment and release process
 ...
 - create virtualenv with Flask and Cat and Kittens installed into it (latter is installed in
...
install it (`pip install hseling_api_cat_and_kittens.tar.gz`), ensure that configuration file exists and
`HSELING_API_CAT_AND_KITTENS_SETTINGS` environment variable points to it, ensure that user has access to the
